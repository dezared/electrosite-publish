  ...
  return (
    <List>
      <Datagrid rowClick="edit" bulkActionButtons={<PostBulkActionButtons />}>
        ...
        <TextField
          source="wareSaftyInfo"
          label="Информация по теплосохранению"
        />
  ...
  return (
    <Edit>
      <SimpleForm>
        ...
        />
        <ImageInput
          source="picturesAdded"
          label="Дополнительные изоображения"
          accept="image/*"
          multiple={true}
        >
        ...
        <TextInput
          source="foundamentInfo"
          multiline
          label="Информация по фундамету"
        />
        <TextInput source="wallsInfo" multiline label="Информация по стенам" />
        <TextInput
          source="perekritie"
          multiline
          label="Информация по перекрытию"
        />
        ...
        <TextInput
          source="peregorodgiInfo"
          multiline
          label="Информация по перегордке"
        />
        <br />
        <br />
        <br />
